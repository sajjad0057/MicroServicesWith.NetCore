namespace Sajshop.web.Models.Ordering;
...
public record PaymentModel(string CardName, string CardNumber, string CardHolderName, string Expiration, string Cvv, int PaymentMethod);
